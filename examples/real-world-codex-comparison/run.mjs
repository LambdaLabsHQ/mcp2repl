...
function renderPrompt(mode) {
  const modeInstructions = {
    ...
    repl: [
      ...
      "Task module size budget: keep the task module under 180 lines. Do not build a broad resilient scraper, configurator engine, click automation library, compare-table parser framework, or large targeted-repair loop. Use simple line-based extraction from visible page text and controls.",
